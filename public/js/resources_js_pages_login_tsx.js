...
/***/ "./resources/js/components/alert.ts":
/*!******************************************!*\
  !*** ./resources/js/components/alert.ts ***!
  \******************************************/
...
var sweetAlert = function sweetAlert(_ref) {
  var icon = _ref.icon,
    title = _ref.title;
...
/***/ "./resources/js/components/axios.ts":
/*!******************************************!*\
  !*** ./resources/js/components/axios.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var alert_1 = __importDefault(__webpack_require__(/*! ./alert */ "./resources/js/components/alert.ts"));
...
var Layout = function Layout(_ref) {
  var children = _ref.children,
    ...
    isEmail = _ref$isEmail === void 0 ? false : _ref$isEmail;
  return react_1["default"].createElement("div", {
    ...
    className: isEmail ? "col-12" : "col-md-8 col-lg-6 offset-md-2 offset-lg-3"
  }, children))));
};
...
var axios_1 = __importDefault(__webpack_require__(/*! ../components/axios */ "./resources/js/components/axios.ts"));
var alert_1 = __importDefault(__webpack_require__(/*! ../components/alert */ "./resources/js/components/alert.ts"));
var Login = function Login() {
  ...
  var handleInput = function handleInput(e) {
    setData(Object.assign(Object.assign({}, data), _defineProperty({}, e.target.id, e.target.value)));
  };
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            _context.next = 3;
            return axios_1["default"].post('/', data);
          case 3:
            res = _context.sent;
            (0, alert_1["default"])({
              icon: 'success',
